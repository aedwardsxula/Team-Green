...
Test 2
Arrange:Smokers ages [59, 37, 29]
Act:Run AgeDistribution.analyze(store)
Assert:Labels are printed in the fixed order.
...
Assert: The output correctly displayed the charge ranges for each BMI group and identified whether the 30–45 BMI group had the largest range.
...
Test 2
Arrange:A dataset of InsuranceRecord objects was created where northern smokers have a higher average age than southern smokers 
Act: A Task17 object was created with this dataset and the compare_smoking_by_region() method was called
Assert:The program prints "Northern smokers are older on average than southern ones"
...
Test 2
Arrange: A dataset of InsuranceRecord objects was created where southern regions have a higher average number of children, but lower average of ages than northern regions.
Act: A Task19 object was created with this dataset and the compare_children_by_region() function was called
Assert: The program prints "Southern regions have more children on average but northern regions have higher average ages.
...
Test 2 
Arrange: A dataset was loaded from the CSV file containing  the number of children and corresponding charged where the correlation is weak
Act: The slope , intercept, and Pearson correlation coefficient were calculated, and predicted charges were generated using the linear regression model
Assert: The program prints the Pearson correlation coefficient close to 0 , confirming a weal correlation and displays the charge values accordingly